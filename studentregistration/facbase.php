  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <!-- Divider -->
	   <li class="nav-item">
        <a class="nav-link collapsed" href="facultyaddstudent.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="addattendance.php">
      ...
      <!-- Attendance Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="addmark.php" >
          <i class="fas fa-school"></i>
          <span>Assessment</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="facleaveapply.php">
          <i class="fas fa-bell"></i>
          <span>Apply leave</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="stuleaveapprove.php">
          <i class="fas fa-bell"></i>
          <span>student leave approval</span>
        </a>
      </li>
