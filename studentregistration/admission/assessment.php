				...
				<form method="post" action="#">
					<div class="form-row">
						...
						<div class="form-group col-md-6">
							<input type="text" placeholder="Assessment Name" class="form-control" required>
						</div>
						<div class="form-group col-md-6">
					...
					<button class="btn btn-info text-white px-5" id="create">Create</button>
					</div>
				</form>
				</div>
			</div>
<!-------------------------------Student details------------------------------------------->
			...
			<div class="card mt-5" id="student">
				...
				<div style="overflow-x:auto;">
					...
					<div class="text-center py-3">
					<button class="btn btn-info text-white px-5" onclick="ok()">Submit</button>
					</div>
					</div>
			</div>
<!-------------------------------Student details------------------------------------------->
